...
const benefits: Benefit[] = [
  {
    id: 1,
    title: 'أنظمة جاهزة للاستخدام',
    description:
      'احصل على أنظمة أتمتة كاملة جاهزة للتنفيذ فورًا. لا تحتاج لبناء شيء من الصفر.',
    features: [
      'أنظمة n8n جاهزة للنسخ',
      'أنظمة Make كاملة ومجربة',
      'نظام أتمتة هدية عند الانضمام',
    ],
    icon: (
      <svg
        className="w-8 h-8"
  ...
  {
    id: 2,
    title: 'مكالمات أسبوعية شخصية',
    description:
      'جلسات أسبوعية مباشرة معي شخصيًا. أساعدك في حل مشاكلك خطوة بخطوة.',
    features: [
  ...
  },
  {
    ...
    title: 'شهادات معتمدة',
    description:
      'احصل على شهادات تثبت خبرتك في الأتمتة. ميّز نفسك في سوق العمل.',
    features: [
            ...
            >
              ...
              >
                <div className="relative">
                  <div className="aspect-[4/3] bg-gradient-to-br from-cream-200 to-cream-100 rounded-3xl shadow-xl overflow-hidden border border-cream-200">
                    {/* Placeholder */}
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div className="text-center text-forest-600/40">
                        <svg
                        ...
                        <p className="font-medium">صورة توضيحية</p>
                        <p className="text-sm">Benefit {benefit.id} Image</p>
                      </div>
                    </div>
                  </div>
