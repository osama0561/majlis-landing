...
const faqItems: FAQItem[] = [
  ...
  {
    question: 'ماذا يحدث بعد انتهاء عرض الـ 100 عضو؟',
    answer:
      'بعد انضمام أول 100 عضو، سيرتفع السعر إلى $98 شهريًا للأعضاء الجدد. لكن إذا انضممت الآن بسعر $68، ستحافظ على هذا السعر للأبد طالما اشتراكك فعّال.',
  },
];
    ...
    >
      <div className="container-custom">
        ...
        <div className="text-center mt-12">
          <p className="text-forest-600/70 mb-4">
            لم تجد إجابة سؤالك؟
          </p>
          <a
            href="mailto:contact@majlis.com"
